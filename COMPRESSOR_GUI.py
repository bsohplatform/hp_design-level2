...
class compressorWindow(QMainWindow, form_class):
    def __init__(self, Pevap, Pcond, Tcomp_in, mdot, Refrigerant, Pevap_2, Pcond_2, Tcomp_in_2, mdot_2, Refrigerant_2, layout_type):
        ...
        self.comp_picture.setPixmap(QPixmap(".\\DBs\\Compressor_DB\\"+company[0]+"_"+model_name+".pdf").scaledToHeight(571))
        self.operation_boundary.setPixmap(QPixmap(".\\DBs\\Compressor_DB\\Figs\\Operation_boundary.png").scaledToHeight(321))
