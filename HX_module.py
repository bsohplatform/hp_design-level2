        ...
        for j in range(N_row):
            for jj in range(N_element):
                if round(j/2) == j/2: # 짝수
                    ...
                    h_secondary[jj,j+1] = h_secondary[jj,j] - self.secondary_in.q/N_row/self.secondary_in.m
                    ...
                    h_secondary[N_element-jj-1,j+1] = h_secondary[N_element-jj-1,j] - self.secondary_in.q/N_row/self.secondary_in.m
