...
class WindowClass(QMainWindow, form_class):
    ...
    def Bas_batch_result(self):
        ...
        self.REF_table.setItem(3, 0, QTableWidgetItem(str(round(self.OutEvap_REF.m*3600,2))))
        self.REF_table.setItem(3, 1, QTableWidgetItem(str(round(self.InCond_REF.m*3600,2))))
        self.REF_table.setItem(3, 2, QTableWidgetItem(str(round(self.OutCond_REF.m*3600,2))))
        self.REF_table.setItem(3, 3, QTableWidgetItem(str(round(self.InEvap_REF.m*3600,2))))
